...
{
    Node<string> *new_node = new Node<string> (s);
    ...
    if(isEmpty()){
        ...
        Node<string> *aux = this -> head;
        while(aux -> getNext() != this -> tail && new_node -> getValue() > aux -> getValue()){
            aux = aux -> getNext();
        }

        new_node -> setNext(aux);
        new_node -> setPrevious(aux -> getPrevious());
...
Node<string>* LinkedList::searchCF(string s)
{
    ...
    while(aux -> getValue() != s){
        aux = aux -> getNext();
    }
    if(aux != this -> tail){
        int cont = aux -> getCount();
        aux -> setCount(cont);
    }
...
Node<string>* LinkedList::searchMF(string s)
{
    ...
    old = aux -> getNext();
    old -> setPrevious(aux -> getPrevious());
    old = aux -> getPrevious();
    old -> setNext(aux -> getNext());
